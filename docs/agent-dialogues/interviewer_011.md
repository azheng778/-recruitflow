...
**Q：** 在第46组数据分析师招聘初筛中，查询熟悉 Python 和 FastAPI 的候选人
...
**Q：** 基于刚才确认的第46组上下文，查看我被分配的这位候选人详情
